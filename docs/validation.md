...
- GitHub CI additionally covers Python 3.13 and 3.14 on Ubuntu, macOS and
  Windows with `websockets` 17.1; the Ubuntu 3.13 and 3.14 jobs also run the
  optimized (`python -O`) suite.
